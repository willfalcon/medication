/*
  ...
  - Added the required column `medId` to the `LogNote` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_LogNote" ("id", "logId", "note") SELECT "id", "logId", "note" FROM "LogNote";
DROP TABLE "LogNote";
